...
function ProductsScreen() {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(saveProduct({ _id, name, price, image, brand, category, countInStock, description }));
  };
        ...
        <div className="form">
          <form onSubmit={submitHandler}>
            <ul className="form-container">
              <li><h2>{_id ? "Edit Product" : "Create Product"}</h2></li>
              {loadingSave && <li><div>Saving product...</div></li>}
              {errorSave && <li><div className="error">{errorSave}</div></li>}
              ...
              <li>
                ...
                <input type="number" id="countInStock" value={countInStock} onChange={(e) => setCountInStock(Number(e.target.value))} required />
              </li>
              <li>
              ...
              <li>
                <button type="button" onClick={() => setModalVisible(false)} className="button secondary block">
                  Cancel
                </button>
              </li>
            </ul>
